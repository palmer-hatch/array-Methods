...
// // CODE HERE
// const evenNumbers = mixedNumbers.filter((element, index, wholeArray) => element % 2 === 0)
...
// CODE HERE
// const postTaxPrices = prices.map(num => Math.round((num *1.07)*100)/100)
...
// // CODE HERE
// const myStrongest = monstersInYourPocket.filter((element, index, wholeArray) => element.CP > 200)
...
// /*
//   Use a higher order method to get all the order totals after adding in the sales tax (given to you as a tax rate, hint: 
